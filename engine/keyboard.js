...
keyboard["typeKey"] = function (x)
{
	...
	{
		keyboard.deferClipboard = true;
	}
	else if (keyboard.deferClipboard)
	{ // Paste

		let clip = keyboard.clipboard;
...
document.addEventListener('paste', e=>{
	keyboard.clipboard = e.clipboardData.getData('text/plain');
})